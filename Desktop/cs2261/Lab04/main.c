...
void goToGame() {
    ...
    drawString(145,5,"Balls Remaining:", WHITE);
...
void game() {
    ...
    drawRect(145,107,6,8,BLACK);
    drawString(145,106,buffer,WHITE);
