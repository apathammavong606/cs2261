...
# 1 "furtherTrees.h" 1
# 22 "furtherTrees.h"
extern const unsigned short furtherTreesTiles[1872];
...
void initialize() {
    ...
    DMANow(3, furtherTreesTiles, &((charblock *)0x6000000)[0], 3744 / 2);

    DMANow(3, furtherTreesMap, &((screenblock *)0x6000000)[31], 2048 / 2);

    (*(volatile unsigned short*)0x4000008) = (1<<14) | ((1)<<2) | ((29)<<8);

    DMANow(3, treesTiles, &((charblock *)0x6000000)[1], 11968 / 2);

    DMANow(3, treesMap, &((screenblock *)0x6000000)[29], 4096 / 2);
