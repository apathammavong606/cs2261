...
void updatePlayer() {
    ...
    if((~((*(volatile unsigned short *)0x04000130)) & ((1<<6)))) {
        if (pikachu.worldRow > 0
            && collisionmapBitmap[((pikachu.worldRow - 1)*(256)+(pikachu.worldCol))]
            && collisionmapBitmap[((pikachu.worldRow - 1)*(256)+(pikachu.worldCol + pikachu.width - 1))]
    ...
    if((~((*(volatile unsigned short *)0x04000130)) & ((1<<7)))) {
        if (pikachu.worldRow + pikachu.height < 256
            && collisionmapBitmap[((pikachu.worldRow + pikachu.width)*(256)+(pikachu.worldCol))]
            && collisionmapBitmap[((pikachu.worldRow + pikachu.width)*(256)+(pikachu.worldCol + pikachu.width - 1))]
    ...
    if((~((*(volatile unsigned short *)0x04000130)) & ((1<<5)))) {
        if (pikachu.worldCol > 0
            && collisionmapBitmap[((pikachu.worldRow)*(256)+(pikachu.worldCol - 1))]
            && collisionmapBitmap[((pikachu.worldRow + pikachu.height - 1)*(256)+(pikachu.worldCol - 1))]
    ...
    if((~((*(volatile unsigned short *)0x04000130)) & ((1<<4)))) {
        ...
        && collisionmapBitmap[((pikachu.worldRow)*(256)+(pikachu.worldCol + pikachu.width))]
        && collisionmapBitmap[((pikachu.worldRow + pikachu.height - 1)*(256)+(pikachu.worldCol + pikachu.width))]
