...
void updatePlayer() {
    ...
    if(BUTTON_HELD(BUTTON_UP)) {
        if (pikachu.worldRow > 0
            && collisionmapBitmap[OFFSET(pikachu.worldRow - 1, pikachu.worldCol, MAPWIDTH)]
            && collisionmapBitmap[OFFSET(pikachu.worldRow - 1, pikachu.worldCol + pikachu.width - 1, MAPWIDTH)]/*Delete that 1, then:
            ...
            pikachu.worldRow = pikachu.worldRow - pikachu.rdel;
    ...
    if(BUTTON_HELD(BUTTON_DOWN)) {
        if (pikachu.worldRow + pikachu.height < MAPHEIGHT
            && collisionmapBitmap[OFFSET(pikachu.worldRow + pikachu.width, pikachu.worldCol, MAPWIDTH)]
            && collisionmapBitmap[OFFSET(pikachu.worldRow + pikachu.width, pikachu.worldCol + pikachu.width - 1, MAPWIDTH)] /*Delete that 1, then:
            for TODO 1.0, make sure pikachu doesn't go off the map here,
            for TODO 2.2, check collision map here as well*/) {
    ...
    if(BUTTON_HELD(BUTTON_LEFT)) {
        if (pikachu.worldCol > 0
            && collisionmapBitmap[OFFSET(pikachu.worldRow, pikachu.worldCol - 1, MAPHEIGHT)]
            && collisionmapBitmap[OFFSET(pikachu.worldRow + pikachu.height - 1, pikachu.worldCol - 1, MAPHEIGHT)] /*Delete that 1, then:
            for TODO 1.0, make sure pikachu doesn't go off the map here,
            for TODO 2.2, check collision map here as well*/) {

            // Update pikachu's world position if the above is true
            pikachu.worldCol = pikachu.worldCol - pikachu.cdel;
    ...
    if(BUTTON_HELD(BUTTON_RIGHT)) {
        if (pikachu.worldCol + pikachu.width < MAPWIDTH
        && collisionmapBitmap[OFFSET(pikachu.worldRow, pikachu.worldCol + pikachu.width, MAPHEIGHT)]
        && collisionmapBitmap[OFFSET(pikachu.worldRow + pikachu.height - 1, pikachu.worldCol + pikachu.width, MAPHEIGHT)]/*Delete that 1, then:
            for TODO 1.0, make sure pikachu doesn't go off the map here,
            for TODO 2.2, check collision map here as well*/) {
    ...
    // TODO 1.1: Update screen row and screen col
